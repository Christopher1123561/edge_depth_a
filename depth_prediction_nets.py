...
def depth_prediction_resnet18unet(images, is_training, decoder_weight_reg=0.0,
  ...
  with arg_scope([layers.conv2d, layers.conv2d_transpose],
    ...
    # conv_tz1 = padding1(iconv1)
    # conv_tz1 = layers.conv2d(conv_tz1, iconv1.shape[-1], [7, 3], stride=1, padding="valid")
    # padding2 = tf.keras.layers.ZeroPadding2D(padding=((1, 1), (3, 3)))
    # conv_tz2 = padding2(iconv1)
    # conv_tz2 = layers.conv2d(conv_tz2, iconv1.shape[-1], [3, 7], stride=1, padding="valid")
    # iconv1 = conv_tz1 + conv_tz2
