...
from dataset import reader_cityscapes
...
def loss_fn(features, mode, params):
  ...
  # print(motion_features[0].shape)  # (8, 128, 416, 4)
  # print(len(motion_features))  # 2
  # print()
  # print(len(features['rgb'][0].shape))  # 4
  ...
  pairs = tf.concat([motion_features_stack, flipped_motion_features_stack],
                    axis=-1)
  # print(motion_features_stack.shape)  # (16, 128, 416, 4)
  # print(flipped_motion_features_stack.shape)  # (16, 128, 416, 4)
  # print(pairs.shape) # (16, 128, 416, 8)
